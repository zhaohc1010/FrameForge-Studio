<div align="center">
  <img src="./docs/imgs/readme/app-icon.png" width="120" height="120" alt="分镜画布" />
  <h1>分镜画布</h1>
  <p>基于节点画布的AI分镜工作台，一站式完成图片生成编辑与分镜流程。</p>
</div>
...
![分镜画布示例](./docs/imgs/readme/example.png)
...
![注册 Zoo API](./docs/imgs/readme/register.png)

### 第二步，在左侧找到 API 令牌，点击添加令牌

![添加令牌入口](./docs/imgs/readme/token-step-1.png)

### 第三步，随便填入一个名称，分组选择优质 banana，接着点击提交

![填写令牌信息](./docs/imgs/readme/token-step-2.png)

### 第四步，复制 API Key 密钥并粘贴进软件设置

![复制 API Key](./docs/imgs/readme/token-step-3.png)
